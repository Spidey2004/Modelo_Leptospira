...
The application is designed to run directly in a Jupyter Notebook hosted on **Google Colab**.
...
3. Modify the code or parameters as needed for your own experiments.
